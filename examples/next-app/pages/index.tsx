        ...
        {publicAddress && (
          ...
          >
            ...
            <section style={{ marginTop: "20px" }}>
              ...
              <button disabled={!verifierId} style={{ marginTop: "20px" }} onClick={getPublicAddress}>
                Get Public Address
              </button>
            </section>
            ...
            <section style={{ marginTop: "20px" }}>
              ...
              <section>
                ...
                <div>
                  ...
                  />
                  <button disabled={!encryptionKey} onClick={encryptMessage}>
                    Encrypt
                  </button>
                </div>
                <button disabled={!messageEncrypted} onClick={decryptMessage}>
                  Decrypt
                </button>
              </section>
            </section>
