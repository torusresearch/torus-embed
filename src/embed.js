...
const iframeIntegrity = 'sha384-XCIzW9rYRu37DEB1Jait5t0QkzZTYq6kqXXvhlJNUHhFAMl1b9JBaLI2CUidegac'
...
class Torus {
  ...
  init({
    ...
    return new Promise((resolve, reject) => {
      ...
      switch (buildEnv) {
        case 'staging':
          torusUrl = 'https://staging.tor.us/v1.1.1'
          logLevel = 'info'
          break
        case 'testing':
        ...
        case 'development':
          ...
          break
        default:
          torusUrl = 'https://app.tor.us/v1.1.1'
          logLevel = 'error'
          break
      }
