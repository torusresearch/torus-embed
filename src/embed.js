...
const iframeIntegrity = 'sha384-DfpqKvrLBfDpzmKdNFt3l7HzTdFrGJ1Hm+zHyjLBqtzkm6kAqyuQqbjMTQuDLW+y'
...
class Torus {
  ...
  init({
    ...
    return new Promise((resolve, reject) => {
      ...
      switch (buildEnv) {
        case 'staging':
          torusUrl = 'https://staging.tor.us/v1.1.0'
          logLevel = 'info'
          break
        case 'testing':
        ...
        case 'development':
          ...
          break
        default:
          torusUrl = 'https://app.tor.us/v1.1.0'
          logLevel = 'error'
          break
      }
